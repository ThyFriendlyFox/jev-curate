...
SETUP.md step 5 instantiated these into `.github/` on 2026-09-19. Adjust the toolchain
  ...
  release:
    ...
    steps:
      ...
      - name: Build artifacts
        run: python -m build --wheel --outdir dist    # adjust to produce dist/
...
## Branch protection on `master` (repo Settings)
