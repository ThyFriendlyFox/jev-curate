...
Installed from `agent-kit/skills/blog-post/`. Posts go to `posts/` in this repo.
...
3. Write the post in `agent-kit/TONE.md` voice, 300–800 words:
...
- No marketing words. Run the agent-kit/docs/STYLE.md rules over the draft.
